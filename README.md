<h1 aling="center">ERC20 token 📚⛓</h1>
...
<p>In this project we went to a more advanced level, making an ERC20 Token interface, and doing our import to create a Token in minutes.</p>

<p>We create our tests and test each function created in smart contracts, passing them all successfully.</p>

<p>I hope you are encouraged to do this project, it was a lot of fun and the knowledge you will acquire will help you in the future to develop your projects as a professional.</p>
